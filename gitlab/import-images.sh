...
import_images() {
    declare -a images=(
        ...
        "ghcr.io/voxpupuli/container-puppetserver:${PUPPETSERVER_VERSION:-7.17.0-v1.5.0}"
        "ghcr.io/voxpupuli/container-puppetdb:${PUPPETDB_VERSION:-7.18.0-v1.5.0}"
        ...
        "spvest/azure-keyvault-controller:${AZURE_KV2K8S_VERSION:-1.6.0}"
        "spvest/azure-keyvault-webhook:${AZURE_KV2K8S_VERSION:-1.6.0}"
        "spvest/azure-keyvault-env:${AZURE_KV2K8S_VERSION:-1.6.0}"
        ...
        # "quay.io/cilium/cilium-etcd-operator:${CILIUM_ETCD_OPERATOR_VERSION:-v2.0.7}"
